...
1.  show the full name of people working at the same company (Macys)
...
- Contain 5 buttons:
    ...
    * **fab** - floating action button that will allow the user to add themselves to the employee table
